...
const BACKEND_NAME: &str = "telephony-mcp-backend.exe";
const BACKEND_PORT: u16 = 10952;
const BACKEND_TAG: &str = "telephony-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "TELEPHONY_MCP_PORT";
const ENV_HOST: &str = "TELEPHONY_MCP_HOST";
const ENV_TAURI: &str = "TELEPHONY_MCP_TAURI";
